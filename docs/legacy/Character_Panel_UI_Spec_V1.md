...
1. 当前前端优先落地 `InventoryScene` 的 `背包 ↔ 装备槽`。
...
*   **头像切换 (Portrait)**：
    *   提供左右切换箭头，遍历 `clients/web/public/assets/figure/portrait/` 下的 64 张头像。
    *   中央区域放大显示选中的头像。
*   **命名 (Nickname)**：
    *   输入框，限制 2-12 字符。
...
---
*Last Updated: 2026-05-12 (Web Shell aligned)*
