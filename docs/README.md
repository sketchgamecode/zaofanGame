...
5. `docs/design/04_system_specs/Frontend_Layout_Spec_V1.md`
   前端固定舞台、左上随身状态栏、京城/城市/场所底部入口卡、复用 UI 规则。
6. `server/tdd/`
   服务端 API、存档结构、错误码和限制的技术真相源。

## 当前入口规则

1. 玩家默认从 `CityScene` 的大明地图选择城市，再从城市底部入口卡进入各场所。
...
4. 左上随身状态栏不是第二张地图，只保留个人随身功能，例如角色头像入口、资源、随身行囊、战报/邮件。
...
4. “右侧导航承载商店、任务、副本、竞技”是旧结构。当前左上随身状态栏只做个人功能。
