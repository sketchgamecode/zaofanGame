...
Status: Partially Active / Needs Rewrite
Designer: Antigravity
Implementation Allowed: Yes

---

> 2026-05-28 纠偏说明：本文的“大宋造反模拟器 / 水浒”文案方向已过时。当前装备文案应服务“大明体制内升迁”：军户、厂卫、神机营、都察院、国公府、盐商、织造局、流民暗线等。本文的“矩阵生成法”和 JSON 输出流程仍可作为生产方法参考，但 Prompt、词库、典故和例子需要改写为大明包装。

## 1. 管线概述 (Pipeline Overview)

当前项目需要海量装备库来支撑长期数值成长体验。为了在保证质量（符合“大明体制内升迁”文案规范的黑色幽默）的前提下实现高产量，我们将采用 **AI 辅助矩阵生成法**。
...
```text
你是一个熟悉明代权力机构、厂卫、边镇、都察院、勋贵、盐商和市井暗线，且极具黑色幽默感的文案策划。
请为“大明体制内升迁”题材生成 10 件【史诗级】武器配置表。
要求：
1. 槽位 (Slot)：weapon
