...
> 2026-05-28 纠偏说明：本文早期以“大宋黑市”包装撰写，现已过时。当前题材是“大明体制内升迁”，商店不再作为独立“黑市主入口”，而是由京城场所中的任职 NPC / `ServicePosition` 承载。例如神机营军需、盐商会馆账房、织造局采办。本文的装备生成、刷新、购买、出售 action 仍可作为技术参考；题材命名、入口结构和 NPC 表现以 `Power_Structure_and_World_Actor_System_V1.md` 与 `Frontend_Layout_Spec_V1.md` 为准。
...
### 1.1 系统定位
本系统是当前项目的核心数值增长点，参考 Shakes & Fidget 的商店与装备逻辑。
*   **商店服务 (`shop`)**：玩家获取外部数值（装备）的主要渠道。
*   **题材包装**：将 S&F 的“武器店/魔法店”包装为大明京城不同场所中的采购门路，例如神机营军需、盐商会馆暗柜、织造局采办。
...
| S&F 原项 | 当前大明包装名称 | 描述/备注 |
| :--- | :--- | :--- |
| **Mushroom** | **令牌 (Tokens)** | 朝廷颁发的某种“特权证”，在黑市是硬通货。 |
| **Gold** | **铜钱 (Copper)** | 基础流通货币。 |
| **Weapon Shop** | **神机营军需 / 军械库** | 负责出售：武器、头盔、胸甲、护手、靴子。 |
| **Magic Shop** | **盐商暗柜 / 贡品旧物** | 负责出售：项链、腰带、戒指、饰品、护符。 |
...
1. 玩家从京城地图进入具体场所。
2. 场所底部展示任职 NPC 角色卡。
3. 点击 NPC 下方的 `shop` 服务牌进入商店。
4. 商店页显示经手 NPC 的角色卡和交易反馈。
5. 右侧导航栏不再提供商店入口。
